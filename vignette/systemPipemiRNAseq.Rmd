...
Rscript -e "rmarkdown::render('systemPipemiRNAseq.Rmd', c('BiocStyle::html_document'), clean=F); knitr::knit('systemPipemiRNAseq.Rmd', tangle=TRUE)"; Rscript -e "rmarkdown::render('systemPipemiRNAseq.Rmd', c('BiocStyle::pdf_document'))"
-->
