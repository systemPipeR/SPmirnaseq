...
```{r cutadapt_prep, eval=TRUE, warning=FALSE}
...
<!-- <center><img src="fastqReport_before.pdf"></center> -->
...
<!-- <center><img src="fastqReport_after.pdf"></center> -->
...
```{r read_counting_show, eval=FALSE}
countDFmiR <- read.table(system.file("extdata", "countDFmiR.xls", package = "systemPipeR"), header = TRUE)
showDT(countDFmiR)
```
...
cmp <- readComp(file = targets, format = "matrix", delim = "-")
cmp[[1]]
countDFmiR <- read.table(system.file("extdata", "countDFmiR.xls", package = "systemPipeR"), header = TRUE)
...
```{r run_DESeq2_filter, eval=FALSE}
